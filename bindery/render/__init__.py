...
from bindery.render import html_slides as _html_slides
...
_EXTENSIONS = {"pptx": "pptx", "web": "html", "infographic": "svg", "html-slides": "html"}

_RENDERERS = {
    "pptx": _pptx.render,
    "web": _web.render,
    "infographic": _infographic.render,
    "html-slides": _html_slides.render,
}
